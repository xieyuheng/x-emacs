...
| `C-s C-x` | Save (Alternate)            | `x-save-buffer`         | nil                        |
...
| `C-x .`   | Next buffer        | `next-buffer`        | nil             |
| `C-x ,`   | Previous buffer    | `previous-buffer`    | nil             |
| `M-p`     | Previous paragraph | `backward-paragraph` | nil             |
| `M-n`     | Next paragraph     | `forward-paragraph`  | nil             |
...
| `C-t` (in search) | Continue search forward | `isearch-repeat-forward` | nil               |
...
| `C-s C-c` | Clone frame              | `clone-frame`    | nil                               |
| `C-s C-j` | Jump to file:line:column | `x-jump-to-file` | nil                               |
...
| `M-"`         | Add double quotes       | `paredit-meta-doublequote`    | nil                              |
| `C-M-9`       | Wrap with parentheses   | `paredit-wrap-round`          | nil                              |
| `<C-right>`   | Slurp forward           | `paredit-forward-slurp-sexp`  | `right-word`                     |
| `<C-left>`    | Barf forward            | `paredit-forward-barf-sexp`   | `left-word`                      |
| `<C-M-right>` | Barf backward           | `paredit-backward-barf-sexp`  | nil                              |
| `<C-M-left>`  | Slurp backward          | `paredit-backward-slurp-sexp` | nil                              |
